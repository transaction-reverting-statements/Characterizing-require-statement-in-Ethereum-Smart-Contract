...
library MerklePatriciaProof {
        ...
        returns (bool)
    {
        ...
        for (uint i=0; i path.length) {return false;}
        ...
        returns (uint len_)
    {
        ...
        for(uint i=pathPtr; i0) {
            ...
            for(uint i=offset; i MessageStatus) outbox;
...
2. Stake and Mint (Revert): Normal flow
        ...
        revertStake          --->   confirmRevertStakeIntent
                                            |
      progressRevertStake       confirmStakeIntent (by facilitator)
                               |
                        facilitator (offline)
             |
